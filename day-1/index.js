...
function checkDuplicate() {
    ...
    function removeSpaces(itemText) {
        return itemText.replace(/\s/g, '').toLowerCase();
    }

    const updatedItemText = removeSpaces(itemText);
    
    const isDuplicate = listArr.some(item => removeSpaces(item) === updatedItemText);
